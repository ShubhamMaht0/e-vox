const board = document.querySelector('.board');
        ...
        const constitutionQuestions = [
            { question: "Which gas is the primary cause of global warming?", answer: "Carbon dioxide" },
            { question: "The ozone layer protects us from:", answer: "UV Rays" },
            { question: "Which renewable source of energy is produced by moving air?", answer: "Wind energy" },
            { question: "Non-renewable fossil fuel", answer: "Coal" },
            { question: "Device used to measure air pollution", answer: "Airmeter" }
        ];
